    ...
    var userTeste = User(id: "User Teste",
                         unblockedCuriosities: [Curiosity(isBlocked: false, title: "local", shortDescription: "curta", longDescription: "longa", images: [UIImage(named: "foto-teste")!]),
                                                Curiosity(isBlocked: true,
                                                          ...
                                                          images: [UIImage(named: "foto-teste")!])],
                         badges: [])
//                            Badge(name: "Primeira Descoberta!",
...
//                                        curiositiesNeeded: 15)] )
    ...
    var allLocations: [Location] = [Location(isBlocked: true,
                                             ...
                                             geotification: Geotification(coordinate: CLLocationCoordinate2D(latitude: -8.048835, longitude: -34.959437), radius: CLLocationDistance(30.0), identifier: "pracaVarzea", eventType: .onEntry)),
                                    Location(isBlocked: true,
                                             ...
                                             curiosity: Curiosity(isBlocked: true,
                                                                  ...
                                                                  images: [UIImage(named: "check-box-empty")!]),
                                             coordinate: CLLocationCoordinate2D(latitude: -8.055340, longitude: -34.959053),
                                             geotification: Geotification(coordinate: CLLocationCoordinate2D(latitude: -8.055340, longitude: -34.959053), radius: CLLocationDistance(30.0), identifier: "biblioteca", eventType: .onEntry)),
                                    Location(isBlocked: true,
                                             ...
                                             curiosity: Curiosity(isBlocked: true,
                                                                  ...
                                                                  images: [UIImage(named: "check-box-empty")!]),
                                             coordinate: CLLocationCoordinate2D(latitude: -8.048496, longitude: -34.958206),
                                             geotification: Geotification(coordinate: CLLocationCoordinate2D(latitude: -8.048496, longitude: -34.958206), radius: CLLocationDistance(30.0), identifier: "centroBudista", eventType: .onEntry)),
                                    Location(isBlocked: true,
                                             ...
                                             curiosity: Curiosity(isBlocked: true,
                                                                  ...
                                                                  images: [UIImage(named: "check-box-empty")!]),
                                             coordinate: CLLocationCoordinate2D(latitude: -8.049530, longitude: -34.957576),
                                             geotification: Geotification(coordinate: CLLocationCoordinate2D(latitude: -8.049530, longitude: -34.957576), radius: CLLocationDistance(30.0), identifier: "principeBrega", eventType: .onEntry)),
                                    Location(isBlocked: true,
                                             ...
                                             curiosity: Curiosity(isBlocked: true,
                                                                  ...
                                                                  images: [UIImage(named: "check-box-empty")!]),
                                             coordinate: CLLocationCoordinate2D(latitude: -8.028893, longitude: -34.953968),
                                             geotification: Geotification(coordinate: CLLocationCoordinate2D(latitude: -8.028893, longitude: -34.953968), radius: CLLocationDistance(30.0), identifier: "temploGenezio", eventType: .onEntry)),
                                    Location(isBlocked: true,
                                             ...
                                             curiosity: Curiosity(isBlocked: true,
                                                                  ...
                                                                  images: [UIImage(named: "check-box-empty")!]),
                                             coordinate: CLLocationCoordinate2D(latitude: -8.036291, longitude: -34.975185),
                                             geotification: Geotification(coordinate: CLLocationCoordinate2D(latitude: -8.036291, longitude: -34.975185), radius: CLLocationDistance(30.0), identifier: "cachoeira", eventType: .onEntry)),
                                    Location(isBlocked: true,
                                             ...
                                             curiosity: Curiosity(isBlocked: true,
                                                                  ...
                                                                  images: [UIImage(named: "check-box-empty")!]),
                                             coordinate: CLLocationCoordinate2D(latitude: -8.049837, longitude: -34.959084),
                                             geotification: Geotification(coordinate: CLLocationCoordinate2D(latitude: -8.049837, longitude: -34.959084), radius: CLLocationDistance(30.0), identifier: "casarao", eventType: .onEntry)),
                                    Location(isBlocked: true,
                                             ...
                                             curiosity: Curiosity(isBlocked: true,
                                                                  ...
                                                                  images: [UIImage(named: "check-box-empty")!]),
                                             coordinate: CLLocationCoordinate2D(latitude: -8.036278, longitude: -34.942833),
                                             geotification: Geotification(coordinate:  CLLocationCoordinate2D(latitude: 37.703026, longitude: -121.759735), radius: CLLocationDistance(75.0), identifier: "easteregg", eventType: .onEntry))]
    
    
    var allBlockedBadges: [Badge] = [Badge(name: "Coming Soon",
                                           description: "Coming Soon",
                                           image: UIImage(named: "tickatPracaVarzea")!,
                                           curiositiesNeeded: 1, location: "Praça da Várzea"),
                                     Badge(name: "Coming Soon",
                                           description: "Coming Soon",
                                           image: UIImage(named: "tickatLibrary")!,
                                           curiositiesNeeded: 5, location: "Biblioteca José Antônio Gonsalves de Mello"),
                                     Badge(name: "Coming Soon",
                                           description: "Coming Soon",
                                           image: UIImage(named: "tickatMeditation")!,
                                           curiositiesNeeded: 10, location: "Centro de Estudos Budistas Bodisatva"),
                                     Badge(name: "Coming Soon",
                                           description: "Coming Soon",
                                           image: UIImage(named: "tickatPrinceOfBrega")!,
                                           curiositiesNeeded: 15, location: "O eterno príncipe do brega"),
                                     Badge(name: "Coming Soon",
                                           description: "Coming Soon",
                                           image: UIImage(named: "tickatStatue")!,
                                           curiositiesNeeded: 15, location: "Templo de Genézio Gomes"),
                                     Badge(name: "Coming Soon",
                                           description: "Coming Soon",
                                           image: UIImage(named: "tickatBoi")!,
                                           curiositiesNeeded: 15, location: "Cachoeira e Boi da Mata"),
                                     Badge(name: "Coming Soon",
                                           description: "Coming Soon",
                                     ...
                                     Badge(name: "Coming Soon",
                                           description: "Coming Soon",
                                           image: UIImage(named: "tickatPracaVarzea")!,
                                           curiositiesNeeded: 15, location: "Ponto de ônibus")]
